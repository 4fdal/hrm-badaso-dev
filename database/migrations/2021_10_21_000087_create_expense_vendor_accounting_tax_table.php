...
class CreateExpenseVendorAccountingTaxTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('expense_vendor_accounting_tax', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('expense_vendor_accounting_tax');
    }
}