...
class CreateTimeOffsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('time_offs', function (Blueprint $table) {
            ...
            $table->foreign('manager_employee_id')->references('id')->on('employees')->onDelete('cascade');
            $table->foreign('time_off_type_id')->references('id')->on('time_off_types')->onDelete('cascade');
            $table->foreign('employee_id')->references('id')->on('employees')->onDelete('cascade');
            $table->foreign('departement_id')->references('id')->on('departements')->onDelete('cascade');
            $table->foreign('metting_calendar_event_id')->references('id')->on('calendar_events')->onDelete('cascade');
