...
class CreateTaxCurrentAccountTagsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tax_current_account_tags', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('account_tag_id')->references('id')->on('account_tags')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('tax_current_account_tags');
    }
}