...
class CreateEmployeesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->foreign('approve_time_off_user_id')->references('id')->on('badaso_users')->onDelete('cascade');
            $table->foreign('approve_expenses_user_id')->references('id')->on('badaso_users')->onDelete('cascade');
            $table->foreign('work_id')->references('id')->on('workes')->onDelete('cascade');
            $table->foreign('certificate_level_id')->references('id')->on('degrees')->onDelete('cascade');
            $table->foreign('country_id')->references('id')->on('countries')->onDelete('cascade');
            $table->foreign('country_of_birth_id')->references('id')->on('countries')->onDelete('cascade');
