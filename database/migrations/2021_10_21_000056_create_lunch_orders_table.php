...
class CreateLunchOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('lunch_orders', function (Blueprint $table) {
            ...
            $table->foreign('lunch_product_category_id')->references('id')->on('lunch_product_categories')->onDelete('cascade');
            $table->foreign('lunch_vendor_id')->references('id')->on('lunch_products')->onDelete('cascade');
