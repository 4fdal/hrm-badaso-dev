...
class Account extends Model
{
    ...
    public $belongs_relation = [["foreign" => 'currency_id', "references" => 'id', "on" => 'currencies', "model_on" => Currency::class],["foreign" => 'account_type_id', "references" => 'id', "on" => 'account_types', "model_on" => AccountType::class],["foreign" => 'company_id', "references" => 'id', "on" => 'companies', "model_on" => Company::class],["foreign" => 'account_group_id', "references" => 'id', "on" => 'account_groups', "model_on" => AccountGroup::class]] ;

    public $many_relation = [["foreign" => 'default_account_id', "references" => 'id', "on" => 'account_journals', "model_on" => AccountJournal::class],["foreign" => 'payment_debit_account_id', "references" => 'id', "on" => 'account_journals', "model_on" => AccountJournal::class],["foreign" => 'payment_credit_account_id', "references" => 'id', "on" => 'account_journals', "model_on" => AccountJournal::class],["foreign" => 'suspensi_account_id', "references" => 'id', "on" => 'account_journals', "model_on" => AccountJournal::class],["foreign" => 'profit_account_id', "references" => 'id', "on" => 'account_journals', "model_on" => AccountJournal::class],["foreign" => 'lost_account_id', "references" => 'id', "on" => 'account_journals', "model_on" => AccountJournal::class]] ;
