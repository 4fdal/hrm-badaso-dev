...
class Company extends Model
{
    ...
    public $belongs_relation = [["foreign" => 'currency_id', "references" => 'id', "on" => 'currencies'],["foreign" => 'parent_id', "references" => 'id', "on" => 'companies'],["foreign" => 'partner_id', "references" => 'id', "on" => 'partners']] ;

    public $many_relation = [["foreign" => 'company_id', "references" => 'id', "on" => 'partners'],["foreign" => 'parent_id', "references" => 'id', "on" => 'companies'],["foreign" => 'company_id', "references" => 'id', "on" => 'workes'],["foreign" => 'company_id', "references" => 'id', "on" => 'departements'],["foreign" => 'company_id', "references" => 'id', "on" => 'jobs'],["foreign" => 'company_id', "references" => 'id', "on" => 'applicants'],["foreign" => 'company_id', "references" => 'id', "on" => 'time_off_types'],["foreign" => 'for_company_id', "references" => 'id', "on" => 'time_off_allocations'],["foreign" => 'company_id', "references" => 'id', "on" => 'lunch_vendors'],["foreign" => 'company_id', "references" => 'id', "on" => 'lunch_locations'],["foreign" => 'company_id', "references" => 'id', "on" => 'lunch_product_categories'],["foreign" => 'company_id', "references" => 'id', "on" => 'lunch_orders'],["foreign" => 'company_id', "references" => 'id', "on" => 'fleet_vehicles'],["foreign" => 'company_id', "references" => 'id', "on" => 'account_types'],["foreign" => 'company_id', "references" => 'id', "on" => 'account_taxes'],["foreign" => 'company_id', "references" => 'id', "on" => 'account_groups'],["foreign" => 'company_id', "references" => 'id', "on" => 'accounts'],["foreign" => 'company_id', "references" => 'id', "on" => 'banks'],["foreign" => 'company_id', "references" => 'id', "on" => 'partner_banks'],["foreign" => 'company_id', "references" => 'id', "on" => 'account_journals'],["foreign" => 'company_id', "references" => 'id', "on" => 'expense_reports']] ;
    ...
    public function parent(){ return $this->belongsTo(Company::class); }
