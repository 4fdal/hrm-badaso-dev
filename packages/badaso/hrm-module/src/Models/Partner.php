...
class Partner extends Model
{
    ...
    public $belongs_relation = [["foreign" => 'parent_id', "references" => 'id', "on" => 'partners', "model_on" => Partner::class],["foreign" => 'industry_id', "references" => 'id', "on" => 'industries', "model_on" => Industry::class],["foreign" => 'commercial_partner_id', "references" => 'id', "on" => 'partners', "model_on" => Partner::class],["foreign" => 'company_id', "references" => 'id', "on" => 'companies', "model_on" => Company::class]] ;

    public $many_relation = [["foreign" => 'parent_id', "references" => 'id', "on" => 'partners', "model_on" => Partner::class],["foreign" => 'commercial_partner_id', "references" => 'id', "on" => 'partners', "model_on" => Partner::class],["foreign" => 'partner_id', "references" => 'id', "on" => 'companies', "model_on" => Company::class],["foreign" => 'partner_id', "references" => 'id', "on" => 'calendar_attendees', "model_on" => CalendarAttendee::class],["foreign" => 'partner_id', "references" => 'id', "on" => 'lunch_vendors', "model_on" => LunchVendor::class],["foreign" => 'partner_id', "references" => 'id', "on" => 'fleet_vendors', "model_on" => FleetVendor::class],["foreign" => 'driver_partner_id', "references" => 'id', "on" => 'fleet_vehicles', "model_on" => FleetVehicle::class],["foreign" => 'future_driver_partner_id', "references" => 'id', "on" => 'fleet_vehicles', "model_on" => FleetVehicle::class],["foreign" => 'driver_partner_id', "references" => 'id', "on" => 'fleet_services', "model_on" => FleetService::class],["foreign" => 'partner_id', "references" => 'id', "on" => 'partner_banks', "model_on" => PartnerBank::class]] ;
