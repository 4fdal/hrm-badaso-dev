...
class CreateAccountJournalsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create(config('badaso.database.prefix').'account_journals', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('default_account_id')->references('id')->on(config('badaso.database.prefix').'accounts')->onDelete('cascade');
            $table->foreign('payment_debit_account_id')->references('id')->on(config('badaso.database.prefix').'accounts')->onDelete('cascade');
            $table->foreign('payment_credit_account_id')->references('id')->on(config('badaso.database.prefix').'accounts')->onDelete('cascade');
            $table->foreign('suspensi_account_id')->references('id')->on(config('badaso.database.prefix').'accounts')->onDelete('cascade');
            ...
            $table->foreign('profit_account_id')->references('id')->on(config('badaso.database.prefix').'accounts')->onDelete('cascade');
            $table->foreign('lost_account_id')->references('id')->on(config('badaso.database.prefix').'accounts')->onDelete('cascade');
            $table->foreign('partner_bank_id')->references('id')->on(config('badaso.database.prefix').'partner_banks')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists(config('badaso.database.prefix').'account_journals');
    }
}
