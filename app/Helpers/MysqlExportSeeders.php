 ...
 * Class Export.
 */
class MysqlExportSeeders extends \PDO
{
    /**
     * @var null|string
     */
                ...
                if (is_string($key) && in_array($key, $columns)) {
                    ...
                    if (in_array($key, $booleanValues)) {
                        ...
                        in_array(
                            $key,
                            $timestamps
                        ) && ($value == null || $value == '' || $value == '0000-00-00 00:00:00')
                    ) {
                        ...
                        in_array(
                            $key,
                            $dates
                        ) && $value != null && ($value == '' || $value == '0000-00-00' || $value == '0000')
                    ) {
     ...
     * @param array  $timestamps
     */
    public function generateExport($tables = null, $pathToSeeds = './database/seeders', $booleanValues = [], $timestamps = ['created_at', 'updated_at'])
    {
        /*
         * For PHP 7
         *
